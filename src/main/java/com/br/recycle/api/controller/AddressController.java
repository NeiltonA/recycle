...
public class AddressController {
	...
	/**
	 * Método responsável por conter o endpoint que busca o endereço de acordo com o
	 * CEP informado.
	 * 
	 * @param {@code String} - zipCode
	 * @return {@code ResponseEntity<Dictionary>} - Retorna uma entidade de resposta
	 *         de dictionary.
	 * 
	 */
	 ...
	 * @return {@code AddressDtoOut} - Retorna uma saída de dados de endereço.
	 * 
	 */
	// @PreAuthorize("hasRole('USER')")
	...
	/**
	 * Método responsável por conter o endpoint que cadastra um endereço na base de
	 * dados.
	 * 
	 * @param {@code AddressInput} addressInput
	 * @return {@code ResponseEntity<ApiResponse>} - Retorna o status de criado e
	 *         uma resposta da entidade de endereço.
	 */
	// @PreAuthorize("hasRole('USER')")
	...
	public ResponseEntity<ApiResponse> save(@Valid @RequestBody AddressInput addressInput) {
		...
		return ResponseEntity.created(URI.create("")).body(new ApiResponse(true, "Endereço cadastrado com sucesso."));
	}

	/**
	 * Método responsável por conter o endpoint que atualização de um endereço na
	 * base de dados.
	 * 
	 * @param {@code Long} - id
	 * @param {@code AddressInput} - addressInput
	 * @return {@code ResponseEntity<ApiResponse>} - Retorna o status de OK e uma
	 *         resposta da entidade de endereço atualizada.
	 */
	// @PreAuthorize("hasRole('USER')")
	...
	public ResponseEntity<ApiResponse> update(@PathVariable("id") Long id, @RequestBody AddressInput addressInput) {
		...
		return ResponseEntity.ok(new ApiResponse(true, "Endereço atualizado com sucesso."));

	}

	/**
	 * Método responsável por conter o endpoint que deleta um endereço na
	 * base de dados.
	 * 
	 * @param {@code Long} - id
	 * @return {@code ResponseEntity<ApiResponse>} - Retorna o status de NO CONTENT 
	 * 	para uma deleção com sucesso.
	 */
	// @PreAuthorize("hasRole('USER')")
